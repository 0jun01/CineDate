...
public class UserController {
	...
	public String updateUser(@RequestParam("name") String name, @RequestParam("password") String password,
		...
		if (loginId == null || loginId.isEmpty()) {
			throw new IllegalArgumentException(Define.INVALID_INPUT);
		}

// 사용자 정보 업데이트
		userService.updateUser(loginId, name, password, email, phoneNum);
