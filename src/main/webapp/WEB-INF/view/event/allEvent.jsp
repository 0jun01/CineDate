	...
	<div id="in--wrap">
		...
		<ul class="evt--area--menu">
			<div class="evt--prize">
				...
				<span>&nbsp;&nbsp;|&nbsp;&nbsp;</span>
				<a href="/event/allevent" class="evt--prize--win" style="color: #ff2588;">이벤트 전체보기</a>
				<span>&nbsp;&nbsp;|&nbsp;&nbsp;</span>
					...
					<c:forEach var="event" items="${eventList}">
						<div class="evt--item">
							<a href="/event/eventDetail?id=${event.id}">
								<div class="event--img" style="background-image: url('/DateProfileIMAGE/${event.DateProfileIMAGE}');"></div>
								<div class="event--txt">
