			...
			<form action="" method="">
				<div class="login--wrap">
					<div class="join--btn">
						...
						<input type="text" id="id" name="id" placeholder="아이디를 입력해주세요. (6~15자)">
						<button class="duplication"><a href="">중복확인</a></button>
					</div>
					...
					<input type="number" id="phone" name="phone" placeholder="휴대폰 번호를  입력해주세요.">
					...
					<div class="gender--box">
						<input type="radio" id="female" name="gender"><span class="gender--items">여자</span>
						<input type="radio" id="male" name="gender"><span class="gender--items">남자</span>
					</div>
