				...
				<div class="col-12">
					...
					<div class="card">
						...
						<div class="card-header" style="display: flex; flex-direction: row">
							<span class="card-title col-10" id="title" style="resize: none; border-style: none">${notice.title}</span>
							<div class="col-md-6 card-title">
								<span class="input-group-text col-md-4" id="category">${notice.category} </span>
							</div>
