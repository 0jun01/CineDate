			...
			<div class="row">
				<div class="col-12">
					...
					<div class="card">
						...
						<div class="card-body">
							<img class="form-control" id="content" style="resize: none; border-style: none" src="<c:url value='/DateProfileIMAGE/${event.uploadFileName}' />" width="50%" onerror="this.onerror = null; this.src='/img/usernone.jpg'" alt="사진">
						</div>
						<!-- /.card-body -->
